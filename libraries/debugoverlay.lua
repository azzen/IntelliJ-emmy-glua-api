...
--- (client/server) Displays an axis indicator at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Axis]
...
--- (client/server) Displays a solid coloured box at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Box]
--- @param origin Vector @ Position origin
...
--- (client/server) Displays a solid colored rotated box at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.BoxAngles]
...
--- (client/server) Creates a coloured cross at the specified position for the specified time. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Cross]
...
--- @param color table @ The color of the cross. Uses the [Color](https://wiki.facepunch.com/gmod/Color)
--- @param ignoreZ boolean @ If true, will draw on top of everything; ignoring the Z buffer
--- @return void
function debugoverlay.Cross(position, size, lifetime, color, ignoreZ) end

--- (client/server) Displays 2D text at the specified coordinates. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.EntityTextAtPosition]
...
--- (client/server) Draws a 3D grid of limited size in given position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Grid]
--- @param position Vector @ No description provided
--- @return void
function debugoverlay.Grid(position) end

--- (client/server) Displays a coloured line at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Line]
--- @param pos1 Vector @ First position of the line
--- @param pos2 Vector @ Second position of the line
--- @param lifetime number @ Number of seconds to appear
--- @param color table @ The color of the line. Uses the [Color](https://wiki.facepunch.com/gmod/Color)
--- @param ignoreZ boolean @ If true, will draw on top of everything; ignoring the Z buffer
--- @return void
function debugoverlay.Line(pos1, pos2, lifetime, color, ignoreZ) end

--- (client/server) Displays text triangle at the specified coordinates. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.ScreenText]
...
--- (client/server) Displays a coloured sphere at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Sphere]
--- @param origin Vector @ Position origin
...
--- (client/server) Displays "swept" box, two boxes connected with lines by their verices. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.SweptBox]
...
--- (client/server) Displays text at the specified position. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Text]
--- @param origin Vector @ Position origin
...
--- (client/server) Displays a colored triangle at the specified coordinates. 
--- [https://wiki.facepunch.com/gmod/debugoverlay.Triangle]
