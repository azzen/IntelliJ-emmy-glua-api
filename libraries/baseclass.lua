...
--- (client/menu/server) Gets the base class of an an object.
...
--- (client/menu/server) Add a new base class that can be derived by others. This is done automatically for:
--- * widgets
--- * panels
--- * drive modes
--- * entities
