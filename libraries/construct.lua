...
--- [https://wiki.facepunch.com/gmod/construct.Magnet]
...
--- @param key number @ The key to toggle the magnet, see [KEY](https://wiki.facepunch.com/gmod/Enums/KEY)
...
--- [https://wiki.facepunch.com/gmod/construct.SetPhysProp]
...
--- @param data table @ The table containing properties to apply. See [PhysProperties](https://wiki.facepunch.com/gmod/Structures/PhysProperties)
--- @return void
