...
--- (client/menu/server) Calls all hooks associated with the given event until one returns something other than nil, and then returns that data.
...
--- (client/menu/server) Calls hooks associated with the given event.
