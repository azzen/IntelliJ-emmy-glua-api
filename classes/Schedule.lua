...
--- [https://wiki.facepunch.com/gmod/Schedule:EngTask]
...
--- [https://wiki.facepunch.com/gmod/Schedule:GetTask]
--- @param num number @ Task index.
--- @return void
function Schedule:GetTask(num) end

--- (server) Initialises the Schedule. Called by [ai_schedule.New](https://wiki.facepunch.com/gmod/ai_schedule.New) when the Schedule is created. 
--- [https://wiki.facepunch.com/gmod/Schedule:Init]
--- @param debugName string @ The name passed from [ai_schedule.New](https://wiki.facepunch.com/gmod/ai_schedule.New).
--- @return void
function Schedule:Init(debugName) end

--- (server) Returns the number of tasks in the schedule. 
--- [https://wiki.facepunch.com/gmod/Schedule:NumTasks]
--- @return number
