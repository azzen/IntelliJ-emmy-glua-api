...
--- (client/server) Calculates the cross product of this vector and the passed one.
...
--- (client/server) Returns a normalized version of the vector. Normalized means vector with same direction but with length of 1.
...
--- (client/server) Returns the squared length of the vectors x and y value, x² + y².
...
--- (client/server) Returns the squared length of the vector, x² + y² + z².
...
--- (client/server) Rotates a vector by the given angle.
...
--- (client/server) Translates the [Vector](https://wiki.facepunch.com/gmod/Vector) (values ranging from 0 to 1) into a [Color](https://wiki.facepunch.com/gmod/Color). This will also range the values from 0 - 1 to 0 - 255.
--- x * 255 -> r
--- y * 255 -> g
--- z * 255 -> b
